 ...
 * @version $Revision: $
 */
public class GreenMailManagedConnection implements ManagedConnection {

	/** The logger */
	private static Logger log = Logger.getLogger(GreenMailManagedConnection.class.getName());
	...
	/** Connection */
	private GreenMailConnectionImpl connection;
    ...
    public MimeMessage[] getReceivedMessages() {
    	return ((GreenMailResourceAdapter)mcf.getResourceAdapter()).getGreenMail().getReceivedMessages();
    }
    
    public GreenMailUtil util() {
    	return ((GreenMailResourceAdapter)mcf.getResourceAdapter()).getGreenMail().util();
    }
